...
func (s *Store) EnqueueRefreshWithAudit(ctx context.Context, job *db.RefreshJob, audit db.RefreshEnqueueAuditBuilder) (bool, int, error) {
...
func (s *Store) enqueueRefresh(ctx context.Context, job *db.RefreshJob, audit db.RefreshEnqueueAuditBuilder, countPosition bool) (bool, int, error) {
