...
func (s *streamingVulnCheckImportStore) ImportVulnCheckStreamWithAudit(ctx context.Context, _ string, stream func(func([]db.VulnCheckEntry) error) (*db.FeedSyncStatus, int, error), audit func(imported, deleted int) *db.AdminAuditEntry) (int, int, error) {
	updated := 0
	...
	if audit != nil {
		if err := s.InsertAdminAuditLog(ctx, audit(updated, 0)); err != nil {
			return updated, total, err
		}
	}
...
func (s *atomicFailingVulnCheckStore) ImportVulnCheckStreamWithAudit(ctx context.Context, _ string, stream func(func([]db.VulnCheckEntry) error) (*db.FeedSyncStatus, int, error), audit func(imported, deleted int) *db.AdminAuditEntry) (int, int, error) {
	s.streamCalls++
