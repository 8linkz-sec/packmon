...
func (s *readOnlyCheckStore) EnqueueRefreshWithAudit(context.Context, *db.RefreshJob, db.RefreshEnqueueAuditBuilder) (bool, int, error) {
...
func (s *importErrorStore) ImportVulnCheckWithAudit(context.Context, string, []db.VulnCheckEntry, *db.FeedSyncStatus, db.FeedImportAuditBuilder) (int, error) {
...
func (s *importErrorStore) ImportCISAKEVWithAudit(_ context.Context, _ string, ids []string, _ *db.FeedSyncStatus, _ db.FeedImportAuditBuilder) (int, error) {
	if s.cisaErr != nil {
		return 0, s.cisaErr
	}
	if s.statusErr != nil {
...
func (s *importErrorStore) ReplaceCISAKEVWithAudit(_ context.Context, _ string, ids []string, _ *db.FeedSyncStatus, _ db.FeedImportAuditBuilder) (int, int, error) {
	if s.cisaErr != nil {
		return 0, 0, s.cisaErr
	}
	if s.cisaClearErr != nil {
...
func (s *importErrorStore) ImportEPSSWithAudit(_ context.Context, _ string, entries []db.EPSSEntry, _ *db.FeedSyncStatus, _ db.FeedImportAuditBuilder) (int, int, error) {
	if s.epssErr != nil {
		return 0, 0, s.epssErr
	}
	if s.statusErr != nil {
