...
// feedImportAuditFunc is an alias, not a distinct type: it must stay assignable
// to db.FeedImportAuditBuilder in both directions.
type feedImportAuditFunc = db.FeedImportAuditBuilder
...
type feedImportRecordOptions[T any] struct {
	...
	auditedImport func(context.Context, string, []T, []string, *db.FeedSyncStatus, db.FeedImportAuditBuilder) (int, int, error)
}

func importFeedRecords[T any](ctx context.Context, h *FeedImportHandler, feed string, statusInput *feedSyncStatusInput, rawItems []T, rawDeleteIDs []string, audit db.FeedImportAuditBuilder, opts feedImportRecordOptions[T]) (*importResponse, error) {
...
func (h *FeedImportHandler) importVulnerabilities(ctx context.Context, feed string, req *vulnerabilityImportRequest, audit db.FeedImportAuditBuilder) (*importResponse, error) {
...
func (h *FeedImportHandler) importMalicious(ctx context.Context, feed string, req *maliciousImportRequest, audit db.FeedImportAuditBuilder) (*importResponse, error) {
...
func (h *FeedImportHandler) importVulnCheck(ctx context.Context, feed string, req *vulnCheckImportRequest, audit db.FeedImportAuditBuilder) (*importResponse, error) {
...
type vulnCheckStreamImporter interface {
	ImportVulnCheckStreamWithAudit(ctx context.Context, feed string, stream func(func([]db.VulnCheckEntry) error) (*db.FeedSyncStatus, int, error), audit db.FeedImportAuditBuilder) (updated, total int, err error)
}
...
func (h *FeedImportHandler) importCISAKEV(ctx context.Context, feed string, req *cisaKEVImportRequest, audit db.FeedImportAuditBuilder) (*importResponse, error) {
	if err := validateImportStatusInput(req.Status); err != nil {
		return nil, err
	}
...
func (h *FeedImportHandler) importEPSS(ctx context.Context, feed string, req *epssImportRequest, audit db.FeedImportAuditBuilder) (*importResponse, error) {
	if err := validateImportStatusInput(req.Status); err != nil {
		return nil, err
	}
...
func streamImportEntriesObject[Raw, Normalized any](r *http.Request, bodyName string, batchSize int, normalize func([]Raw, int) ([]Normalized, error), emit func([]Normalized) error) (*feedSyncStatusInput, int, error) {
	if batchSize <= 0 {
...
func streamImportEntriesArray[Raw, Normalized any](dec *json.Decoder, bodyName string, offset, batchSize int, normalize func([]Raw, int) ([]Normalized, error), emit func([]Normalized) error) (int, error) {
	tok, err := dec.Token()
	if err != nil {
