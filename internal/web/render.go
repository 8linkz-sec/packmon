...
var webMessagesEN = map[webMessageKey]string{
	...
	webMessageKey("feeds.table.entries"):                                "Updated / Total (last sync)",
	webMessageKey("feeds.table.entries_hint"):                           "Left: entries written or updated by the last sync run. Right: entries that run processed in total. Snapshot of the last run, not the database size.",
	...
	webMessageKey("admin.keys.action.mark_deleted_aria"):                "Permanently delete revoked API key %s (ID %d)",
	webMessageKey("admin.keys.action.mark_deleted"):                     "Delete permanently",
	webMessageKey("admin.keys.action.mark_deleted_question"):            "Permanently delete revoked API key %s (ID %d)?",
	webMessageKey("admin.keys.action.mark_deleted_question_prefix"):     "Permanently delete revoked API key",
	webMessageKey("admin.keys.action.mark_deleted_question_suffix"):     "(ID %d)?",
	webMessageKey("admin.keys.action.delete_impact"):                    "Deleting permanently removes this revoked credential from the key list; admin audit log entries and scan history remain.",
	webMessageKey("admin.keys.action.deleting"):                         "Deleting key",
	webMessageKey("admin.keys.action.confirm_delete_aria"):              "Confirm permanently delete revoked API key %s (ID %d)",
	webMessageKey("admin.keys.action.confirm_delete"):                   "Confirm delete",
	...
	webMessageKey("admin.feeds.table.entries"):                          "Updated / Total (last sync)",
	webMessageKey("admin.feeds.table.entries_hint"):                     "Left: entries written or updated by the last sync run. Right: entries that run processed in total. Snapshot of the last run, not the database size.",
