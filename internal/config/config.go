...
type RetentionConfig struct {
	...
	// DeletedAPIKeys is the maximum age for soft-deleted API key rows. Zero disables pruning.
	DeletedAPIKeys time.Duration
...
func loadRetentionConfig() (RetentionConfig, error) {
	...
	deletedAPIKeyRetention, err := envNonNegativeDurationOrDefault("PACKMON_DELETED_API_KEY_RETENTION", 365*24*time.Hour)
	if err != nil {
		return RetentionConfig{}, err
	}
	...
	return RetentionConfig{
		...
		DeletedAPIKeys:     deletedAPIKeyRetention,
