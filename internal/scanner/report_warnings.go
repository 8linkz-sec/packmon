...
const (
	zeroPackageScanWarning        = "No packages were evaluated. Check the scan path, ecosystem filters, and supported lockfiles or SBOM inputs."
	parseErrorReportWarningPrefix = "Some dependency inventory could not be evaluated: "
)
