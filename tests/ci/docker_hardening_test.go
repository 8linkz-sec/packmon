...
func TestDockerBuildsStampBinaryMetadata(t *testing.T) {
	...
	for _, want := range []string{
		...
		"PACKMON_GO_BUILDER_IMAGE: ${PACKMON_GO_BUILDER_IMAGE:-golang:1.26.6-alpine@sha256:3889b425f035be855a72fb4755265311293b6d414521f0a519d819df32222d83}",
...
func TestDockerfilePinsAllExternalBaseImagesByDigest(t *testing.T) {
	...
	for _, want := range []string{
		"ARG PACKMON_GO_BUILDER_IMAGE=golang:1.26.6-alpine@sha256:3889b425f035be855a72fb4755265311293b6d414521f0a519d819df32222d83",
		"ARG PACKMON_ALPINE_RUNTIME_IMAGE=alpine:3.24@sha256:28bd5fe8b56d1bd048e5babf5b10710ebe0bae67db86916198a6eec434943f8b",
	} {
